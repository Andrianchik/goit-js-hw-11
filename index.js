...
`);p.innerHTML=t,F.refresh()}const n=document.querySelector(".search-form");u();n.addEventListener("submit",async s=>{s.preventDefault();const t=n.elements.searchInput.value.trim();if(!t){d(),a.show({iconUrl:c,message:"Please enter what you want to find!",messageColor:"#FAFAFB",backgroundColor:"#EF4040",position:"topRight"});return}v(),d();try{const e=await w(t);U(e)}catch(e){a.show({iconUrl:c,message:"Something went wrong. Please try again later.",messageColor:"#FAFAFB",backgroundColor:"#EF4040",position:"topRight"}),console.error(e)}finally{u(),n.reset()}});
